...
const AboutSection = () => {
  return (
    <section id="about" className="md:mx-[120px] px-[16px] md:px-0 md:pt-[110px] pt-[62px]">
          <h3 className="uppercase font-oswald font-semibold text-white text-lg md:mb-5 mb-3">About me</h3>

      <div className=" flex md:flex-row flex-col gap-2  text-black bg-white md:p-10 p-2 rounded-lg">
        ...
        <div className="md:w-1/2 md:pl-4 flex justify-between flex-col">
         <div>
          ...
          <div className="flex flex-wrap md:flex-nowrap mt-4 justify-center gap-5 items-center bottom-0">
            <button
              type="button"
              className="00 px-10 py-2 bg-gray-500 md:text-md text-sm font-santoshi text-white rounded-md"
            >
              Resume
            </button>
            <button
              type="button"
              className="00 px-10 py-2 md:text-md text-sm bg-gray-500 font-santoshi text-white rounded-md"
            >
              Contact
            </button>
          </div>
