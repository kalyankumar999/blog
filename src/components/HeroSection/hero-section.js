  ...
  return (
    <section className="relative mt-[-10px]   w-full  overflow-hidden pb-[4px] pt-[22px] md:px-[68px]  md:py-[80px]">
      ...
      <div className=" relative z-20">
        ...
        <h1 className="animate-slide-up-fade-in-delay  bg-gradient-to-b from-primary-500 to-primary-600 bg-clip-text text-center font-oswald text-[10vw] font-[600] uppercase leading-none  text-transparent md:mt-[-48px]">
          Kalyan Kumar
        </h1>
        <h3 className='animate-slide-up-web  text-center font-oswald text-secondary-500 font-semibold text-[5vw]'>
          Web Developer
        </h3>
      </div>
      {/* <div className="z-1 relative px-[6px] pb-[18px] md:mt-[-44px] md:px-[30px] md:py-0">
        <MaskedImageCarousel />
      </div> */}
    </section>
  );
