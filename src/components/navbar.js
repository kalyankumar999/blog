...
const Navbar = () => {
  ...
  return (
    <nav
      ref={navbarRef}
      className="sticky top-0 z-50 flex items-center justify-between px-[24px] bg-[#374151]/80 font-oswald  backdrop-blur-md md:h-[106px] md:pl-[120px] md:pr-[110px] text-white py-4"
    >
      <Link href="/">
